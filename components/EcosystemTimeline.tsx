...
const chapters: Chapter[] = [
  ...
  },
  {
    ...
    title: "We brought\na cake.",
    body: "Moojan built the deck through tonsillitis. Valerie found a bakery 12 min from the office. Karim ordered a yellow cake with strawberry jam filling, white frosting, green writing — our ad headline, actually on the cake — and Uber-couriered it to 1 WTC, 80th floor, 12:45pm. Josh vouched for our creative chops in the room. Jessica still wasn't sure.",
    pullQuote: "If we don't win this — f-them! — Valerie, 2am review",
    accent: "#014737",
    accent2: "#09090b",
    bg: "#ffffff",
    Icon: Lightbulb,
